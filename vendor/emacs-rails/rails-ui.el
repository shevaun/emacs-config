...
(defconst rails-minor-mode-nav-menu-bar-map
  (let ((map (make-sparse-keymap)))
    (define-keys map
      ...
      ([goto-stylesheets] '("Go to sass Stylesheets" . rails-nav:goto-sass))
      ([goto-javascripts] '("Go to Javascripts"      . rails-nav:goto-javascripts))
      ([goto-coffeescripts] '("Go to Coffeescripts"  . rails-nav:goto-coffeescripts))
      ...
      ([goto-observers]   '("Go to Features"         . rails-nav:goto-features))
...
(define-keys rails-minor-mode-menu-bar-map
  ...
  ([rails ws use-thin]  '(menu-item "Use Unicorn" (lambda() (interactive)
                                                    (rails-ws:switch-default-server-type "unicorn_rails"))
                                       :button (:toggle . (rails-ws:default-server-type-p "unicorn_rails"))))
  ([rails ws separator] '("--"))
  ...
  ([rails ws production]  '(menu-item "Start Production" rails-ws:start-production
                                      :enable (not (rails-ws:running-p))))
  ([rails ws restart-passenger]  '(menu-item "(Re)Start Passenger" rails-ws:restart-passenger))
...
(define-keys rails-minor-mode-map
  ...
  ((rails-key "\C-c g a") 'rails-nav:goto-sass)
  ((rails-key "\C-c g j") 'rails-nav:goto-javascripts)
  ((rails-key "\C-c g k") 'rails-nav:goto-coffeescripts)
  ((rails-key "\C-c g g") 'rails-nav:goto-migrate)
  ((rails-key "\C-c g p") 'rails-nav:goto-plugins)
  ((rails-key "\C-c g e") 'rails-nav:goto-features)
  ...
  ((rails-key "\C-c w r") 'rails-ws:restart-passenger)
  ...
  ((rails-key "\C-c f a") 'rails-find:sassstylesheets)
  ((rails-key "\C-c f j") 'rails-find:javascripts)
  ((rails-key "\C-c f k") 'rails-find:coffeescripts)
  ...
  ((rails-key "\C-c f u") 'rails-find:test-unit)
  ((rails-key "\C-c f f") 'rails-find:test-functional)
  ((rails-key "\C-c f o") 'rails-find:config)
  ((rails-key "\C-c f e") 'rails-find:features)
  ;; Spec finds
  ...
  ((rails-key "C-/")        'rails-script:toggle-output-window)

  ;; Other
  ((rails-key "C-s")       'rails-grep-project))
