...
(defun rails-nav:goto-stylesheets ()
  "Go to stylesheets."
  (interactive)
  (rails-nav:goto-file-with-menu '("public/stylesheets/" "app/assets/stylesheets/") "Go to stylesheet.." "css" t))

(defun rails-nav:goto-sass ()
  "Go to sass stylesheets."
  (interactive)
  (rails-nav:goto-file-with-menu '("app/stylesheets/" "app/assets/stylesheets/") "Go to sass stylesheet.." "scss" t))

(defun rails-nav:goto-features ()
  "Go to Features."
  (interactive)
  (rails-nav:goto-file-with-menu "features/" "Go to Features.." "feature" t))

(defun rails-nav:goto-javascripts ()
  "Go to JavaScripts."
  (interactive)
  (rails-nav:goto-file-with-menu '("public/javascripts/" "app/assets/javascripts/") "Go to javascript.." "js" t))

(defun rails-nav:goto-coffeescripts ()
  "Go to JavaScripts."
  (interactive)
  (rails-nav:goto-file-with-menu '("app/coffeescripts/" "app/assets/javascripts/") "Go to coffeescript.." "coffee" t))
